import { CircuitSignals, ZKArtifact, groth16 } from "snarkjs"

export async function exportCallDataGroth16(input: CircuitSignals, wasmPath: ZKArtifact, zkeyPath: ZKArtifact) {
